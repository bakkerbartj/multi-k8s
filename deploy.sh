...
kubectl set image deployments/client-deployment server=d0ckd0ck/client-server:$SHA
kubectl set image deployments/worker-deployment server=d0ckd0ck/worker-server:$SHA
