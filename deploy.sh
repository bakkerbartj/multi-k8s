...
kubectl set image deployments/client-deployment client=d0ckd0ck/client-server:$SHA
kubectl set image deployments/worker-deployment worker=d0ckd0ck/worker-server:$SHA